    ...
    <div className="w-screen h-full">
      ...
      >
        <div className=" md:px-0 md:h-1/2 flex text-white flex-col justify-center items-center text-center gap-10 mb-96">
          <FadeIn>
            <div className="uppercase tracking-wider border border-white text-xs px-2 text-center justify-center md:text-lg flex px-4 font-light py-2 rounded-full lineUp">
